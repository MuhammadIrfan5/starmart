...
Route::group(['namespace' => 'Web','middleware' => $middleware], function () {
	...
	// route for to show payment form using get method
		...
		Route::get('/store_paypro', 'PayproController@store');
		...
		Route::get('/points', 'CustomersController@points')->middleware('Customer');
		Route::post('/points/coupon', 'CustomersController@insert')->middleware('Customer');
