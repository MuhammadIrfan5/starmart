...
class OrdersController extends Controller
{
    ...
    public function updateOrder(Request $request)
    {
        ...
        $point= intval($request->order_total/2.5);
        ...
        if ($old_orders_status == $orders_status) {
           ...
           if($request->orders_status == 6){
             ...
             $pointplus = $customerpointscheck->points + $point;
             ...
             $customerpoints = Points::where('customers_id',$customers_id)->update(
                 ...
                 $customerpoints = DB::table('points')->insertGetId(
                     [
                         'customers_id' => $customers_id,
                         'points' => $point,
                     ]
