                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                <label class=" control-label">
                                                      <input type="radio" name="environmentt" value="Maintenance" class="flat-red" <?php if($result['commonContent']['setting']['environmentt'] == 'Maintenance'): ?> checked <?php endif; ?> > &nbsp;<?php echo e(trans('labels.Maintenance')); ?>

                                                </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                                <label class=" control-label">
                                                      <input type="radio" name="environmentt" value="production" class="flat-red" <?php if($result['commonContent']['setting']['environmentt'] == 'production'): ?> checked <?php endif; ?> >  &nbsp;<?php echo e(trans('labels.production')); ?>

                                                </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                                                <label class=" control-label">
                                                      <input type="radio" name="environmentt" value="local" class="flat-red" <?php if($result['commonContent']['setting']['environmentt'] == 'local'): ?> checked <?php endif; ?> >  &nbsp;<?php echo e(trans('labels.local')); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\customecommercea\resources\views/admin/settings/general/setting.blade.php ENDPATH**/ ?>