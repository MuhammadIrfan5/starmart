                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select name="sitename_logo" class="form-control">
                                                        <option <?php if($result['commonContent']['setting']['sitename_logo'] == 'name'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="name"> <?php echo e(trans('labels.Name')); ?></option>
                                                        <option <?php if($result['commonContent']['setting']['sitename_logo'] == 'logo'): ?>
                                                                selected
                                                                <?php endif; ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <img src="<?php echo e(asset($result['commonContent']['setting']['website_logo'])); ?>" alt="" width="80px">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <?php echo Form::hidden('oldImage',  $result['commonContent']['setting']['favicon'] , array('id'=>'favicon')); ?>

                                                    <img src="<?php echo e(asset($result['commonContent']['setting']['favicon'])); ?>" alt="" width="80px">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <?php echo Form::text('facebook_url',  $result['commonContent']['setting']['facebook_url'], array('class'=>'form-control', 'id'=>'facebook_url')); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <?php echo Form::text('google_url', $result['commonContent']['setting']['google_url'], array('class'=>'form-control', 'id'=>'google_url')); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <?php echo Form::text('twitter_url',  $result['commonContent']['setting']['twitter_url'], array('class'=>'form-control', 'id'=>'twitter_url')); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <?php echo Form::text('linked_in',  $result['commonContent']['setting']['linked_in'], array('class'=>'form-control', 'id'=>'linked_in')); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <?php echo Form::text('about_content',  $result['commonContent']['setting']['about_content'], array('class'=>'form-control', 'id'=>'about_content')); ?>

                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;"><?php echo e(trans('labels.aboutStoreText')); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <?php echo Form::text('contact_content', $result['commonContent']['setting']['contact_content'] , array('class'=>'form-control', 'id'=>'contact_content')); ?>

                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;"><?php echo e(trans('labels.contactText')); ?></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select name="allow_cookies" class="form-control">
                                                        <option <?php if($result['commonContent']['setting']['allow_cookies']== '1'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="1"> <?php echo e(trans('labels.Yes')); ?></option>
                                                        <option <?php if($result['commonContent']['setting']['allow_cookies']== '0'): ?>
                                                                selected
                                                                <?php endif; ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\customecommercea\resources\views/admin/settings/general/websetting.blade.php ENDPATH**/ ?>