                  ...
                  <nav id="navigation-mobile">
                      ...
                      <?php if(auth()->guard('customer')->check()){ ?>
                       ...
                       <a href="<?php echo e(url('orders')); ?>" class="main-manu btn btn-primary"><?php echo app('translator')->get('website.Orders'); ?></a>
                        <a href="<?php echo e(url('orders')); ?>" class="main-manu btn btn-primary"><?php echo app('translator')->get('website.Points'); ?></a> 
...
<?php /**PATH F:\xampp\htdocs\customecommercea\resources\views/web/headers/mobile.blade.php ENDPATH**/ ?>