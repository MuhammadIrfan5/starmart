...
function paymentMethods(){
	var currency_code = "<?php echo e(session('currency_code')); ?>";
	jQuery('#loader').show();
	var payment_method = jQuery(".payment_method:checked").val();
	jQuery(".payment_btns").hide();
	if(payment_method == 'instamojo' && currency_code != 'INR'){
		jQuery('#payment_error').show();
		jQuery('#payment_error-error-text').html("<?php echo app('translator')->get('website.Instamojo support indian Currency only.'); ?>");
		jQuery('#loader').hide();
	}else{
...
function getQuantity(){
	...
	jQuery.ajax({
		...
		success: function (res) {
			...
			}else if (1==<?php echo e($result['commonContent']['settings']['Inventory']); ?>){
...
$( ".pointcoupan" ).click(function() {

	let savemoney = $(this).attr("data-savemonet");
	jQuery.ajax({
        headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
        type: "POST",
        url: "<?php echo e(url('/points/coupon')); ?>",
        data: {savemoney}, // serializes the form's elements.
        success: function(data)
        {
	console.log(data);
...
<?php /**PATH F:\xampp\htdocs\customecommercea\resources\views/web/common/scripts.blade.php ENDPATH**/ ?>