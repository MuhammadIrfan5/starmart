            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <?php $__currentLoopData = $unseenOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unseenOrder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li><!-- start message -->
                    <a href="<?php echo e(URL::to("admin/orders/vieworder")); ?>/<?php echo e($unseenOrder->orders_id); ?>">
                      <h4>
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <?php $__currentLoopData = $lowInQunatity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lowInQunatity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li><!-- start message -->
                  <a href="<?php echo e(URL::to("admin/inventoryreport?type=all&dateRange=&products_id=")); ?><?php echo e($lowInQunatity->products_id); ?>">
                      <div class="pull-left">
                         <img src="<?php echo e(asset('').$lowInQunatity->image); ?>" class="img-circle" >
                      </div>
...
<?php /**PATH F:\xampp\htdocs\customecommercea\resources\views/admin/common/header.blade.php ENDPATH**/ ?>