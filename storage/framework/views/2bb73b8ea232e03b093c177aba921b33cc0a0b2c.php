                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                        ...
                                        <?php if(count($listingOrders['orders'])>0): ?>
                                            <?php $__currentLoopData = $listingOrders['orders']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$orderData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <?php if(!empty($result['commonContent']['currency']->symbol_left) && $result['commonContent']['currency']->symbol_left == $orderData->currency): ?>  <?php echo e($orderData->currency); ?>  <?php echo e($orderData->order_price *  $orderData->currency_value); ?> <?php else: ?>  <?php echo e($orderData->order_price *  $orderData->currency_value); ?>  <?php echo e($orderData->currency); ?> <?php endif; ?></td>
                                    ...
                                    <div class="col-xs-12 text-right">
                                        <?php echo e($listingOrders['orders']->links()); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\customecommercea\resources\views/admin/Orders/index.blade.php ENDPATH**/ ?>