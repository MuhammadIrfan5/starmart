  ...
  <div class="col-12 col-md-6">
    ...
    <div class="pro-counter" <?php if(!empty($result['detail']['product_data'][0]->flash_start_date) and $result['detail']['product_data'][0]->server_time < $result['detail']['product_data'][0]->flash_start_date ): ?> style="display: none" <?php endif; ?>>
        <div class="input-group item-quantity">                    
            ...
            value="<?php if(!empty($result['cart'])): ?> <?php echo e($result['cart'][0]->customers_basket_quantity); ?> 
            <?php else: ?> <?php if($result['detail']['product_data'][0]->products_min_order>0 and $result['detail']['product_data'][0]->defaultStock > $result['detail']['product_data'][0]->products_min_order): ?> <?php echo e($result['detail']['product_data'][0]->products_min_order); ?> 
            <?php else: ?> <?php echo e($result['detail']['product_data'][0]->products_min_order); ?> <?php endif; ?> <?php endif; ?>" 
            
            min="<?php if($result['detail']['product_data'][0]->products_min_order>0 and $result['detail']['product_data'][0]->defaultStock > $result['detail']['product_data'][0]->products_min_order): ?>
             <?php echo e($result['detail']['product_data'][0]->products_min_order); ?> 
             <?php else: ?> <?php echo e($result['detail']['product_data'][0]->products_min_order); ?>  <?php endif; ?>" 
            
            max="<?php if(!empty($result['detail']['product_data'][0]->products_max_stock) and $result['detail']['product_data'][0]->products_max_stock>0 and $result['detail']['product_data'][0]->defaultStock > $result['detail']['product_data'][0]->products_max_stock): ?><?php echo e($result['detail']['product_data'][0]->products_max_stock); ?><?php else: ?><?php echo e($result['detail']['product_data'][0]->defaultStock); ?><?php endif; ?>">              
...
<?php /**PATH F:\xampp\htdocs\customecommercea\resources\views/web/common/modal1.blade.php ENDPATH**/ ?>