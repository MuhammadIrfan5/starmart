      ...
      <div class="col-12 col-lg-6">
          ...
          <div class="pro-infos">
              ...
              <?php if($result['detail']['product_data'][0]->products_min_order>0): ?>
                  ...
                  <div class="pro-single-info" id="min_max_setting3"><b><?php echo app('translator')->get('website.Min Order Limit'); ?> : </b><?php echo e($result['detail']['product_data'][0]->products_min_order); ?></div>
                ...
                <?php endif; ?>
                  ...
                  <div class="pro-single-info"  <?php if($result['detail']['product_data'][0]->products_max_stock==9999): ?> style="display:none;" <?php endif; ?> id="min_max_setting2"><b><?php echo app('translator')->get('website.Max Order Limit'); ?> : </b><?php echo e($result['detail']['product_data'][0]->products_max_stock); ?></div>
...
<?php endif; ?>
  ...
  <script>
    ...
    <?php /**PATH F:\xampp\htdocs\customecommercea\resources\views/web/details/detail1.blade.php ENDPATH**/ ?>