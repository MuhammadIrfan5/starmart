              ...
              <table class="table order-table">
                ...
                <tbody>
                  ...
                  <tr class="d-flex">
                    ...
                    <td class="col-12 col-md-2">
                      <?php if($orders->currency == '$'): ?>
                      <?php echo e($orders->currency); ?> <?php echo e($orders->order_price); ?> 
                      <?php else: ?>
                      <?php echo e($orders->order_price * $orders->currency_value); ?> <?php echo e($orders->currency); ?>
                    ...
                    <td class="col-12 col-md-3">
                          ...
                          <?php else: ?>
                            ...
                            <input type="hidden" name="old_orders_status" value="<?php echo e($orders->orders_status_id); ?>">
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\customecommercea\resources\views/web/orders.blade.php ENDPATH**/ ?>