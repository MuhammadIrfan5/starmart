            ...
            <div class="row justify-content-center">
                <div class="col-12 align-self-center">
                    <div class="newsletter">
                        <h5><?php echo app('translator')->get('website.SUBSCRIBE FOR THE LATEST NEWS AND GET 10% DISCOUNT ON SPECIAL ITEMS'); ?></h5>
                        <div class="block">
      ...
      <div class="col-12 col-lg-3">
        <div class="contacts">
          ...
          <ul class="contact-list  pl-0 mb-0">
            ...
            <li> <i class="fas fa-location-arrow"></i><span><?php echo e($result['commonContent']['setting'][4]->value); ?> <?php echo e($result['commonContent']['setting'][5]->value); ?> <?php echo e($result['commonContent']['setting'][6]->value); ?>, <?php echo e($result['commonContent']['setting'][7]->value); ?> <?php echo e($result['commonContent']['setting'][8]->value); ?></span> </li>
...
<?php /**PATH F:\xampp\htdocs\customecommercea\resources\views/web/footers/footer8.blade.php ENDPATH**/ ?>