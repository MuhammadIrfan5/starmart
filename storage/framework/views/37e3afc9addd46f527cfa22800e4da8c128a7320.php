                            ...
                            <div class="row">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group" hidden>
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select name="default_notification" id="default_notification" class="form-control">
                                                        <option <?php if($result['commonContent']['setting']['linked_in'] == 'fcm'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="fcm"> <?php echo e(trans('labels.fcm')); ?></option>
                                                        <option <?php if($result['commonContent']['setting']['linked_in'] == 'onesignal'): ?>
                                                                selected
                                                                <?php endif; ?>
                                            ...
                                            <div class="onesignal_content" >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <?php echo Form::text('onesignal_app_id', $result['commonContent']['setting']['onesignal_app_id'] , array('class'=>'form-control', 'id'=>'onesignal_app_id')); ?>
                                ...
                                <?php echo e(trans('labels.OnesignalAppidText')); ?></span>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <?php echo Form::text('onesignal_sender_id',  $result['commonContent']['setting']['onesignal_sender_id'], array('class'=>'form-control', 'id'=>'onesignal_sender_id')); ?>
                                ...
                                <?php echo e(trans('labels.OnesignalSenderidText')); ?></span>
                                            ...
                                            <div class="fcm_content" <?php if($result['commonContent']['setting']['linked_in'] == 'fcm'): ?>
                                            style="display: block;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <?php echo Form::text('phone_no',  $result['commonContent']['setting']['phone_no'], array('class'=>'form-control', 'id'=>'phone_no')); ?>
                                ...
                                <?php echo e(trans('labels.AppKeyText')); ?></span>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <?php echo Form::text('fcm_android_sender_id',  $result['commonContent']['setting']['fcm_android_sender_id'], array('class'=>'form-control', 'id'=>'fcm_android_sender_id')); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\customecommercea\resources\views/admin/settings/general/pushNotification.blade.php ENDPATH**/ ?>